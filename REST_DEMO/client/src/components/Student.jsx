  ...
  return (
    <tr>
      ...
      <td className='px-6 py-4 whitespace-nowrap flex justify-center gap-3'>
        <button type="button" class="px-5 py-1.5 text-sm font-medium text-white bg-green-500 hover:bg-green-600 rounded text-center">Edit</button>
        <button type="button" class="px-5 py-1.5 text-sm font-medium text-white bg-red-500 hover:bg-red-600 rounded text-center">Delete</button>
      </td>
    </tr>
  )
}
